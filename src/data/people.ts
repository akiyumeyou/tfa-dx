...
export const instructors: Person[] = [
  ...
  },
  {
    ...
    name: "久保 主税",
    initials: "久",
    titles: ["株式会社こそらぼ Co-Founder"],
    photoBase: "instructors/kubo-chikara",
    bio: "インターネットの黎明期から情報技術の分野で活動し、直近15年はデジタル技術をライフサイエンスやヘルスケアの領域で利用することで、人々の健康に貢献できるのではないかという思いで活動。現在は、データによるライフサイエンス産業を立ち上げるための基盤整備の事業開発に従事し、日本の医療DXを進めています。",
